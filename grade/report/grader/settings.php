...
if ($ADMIN->fulltree) {
    ...
    $settings->add(new admin_setting_configcheckbox('grade_report_showparticipantemails', get_string('showparticipantemailsingraderreport', 'grades'),
        get_string('showparticipantemailsingraderreport_help', 'grades'), 0));
