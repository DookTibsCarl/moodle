...
$string['showparticipantemailsingraderreport'] = 'Show emails in grader report';
$string['showparticipantemailsingraderreport_help'] = 'This setting defines if participant email addresses will be displayed in the default grader report. If email address isn\'t checked under Users->Permissions->User policies->Show user identity, this setting has no effect.';
$string['rank'] = 'Rank';
$string['rawpct'] = 'Raw %';
$string['real'] = 'Real';
...
$string['showparticipantemails'] = 'Show participant emails';
$string['showparticipantemails_desc'] = 'Whether to show a participant emails or not in the grader report.';
$string['showparticipantemails_help'] = 'If enabled, participant emails will appear in the grader report. If email address isn\'t checked under Users->Permissions->User policies->Show user identity, this setting has no effect.';
