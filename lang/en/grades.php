...
$string['showparticipantemailsingraderreport_help'] = 'This setting defines if participant email addresses will be displayed in the default grader report. If email address isn\'t configured to be part of user identity, then this setting has no effect.';
$string['rank'] = 'Rank';
$string['rawpct'] = 'Raw %';
$string['real'] = 'Real';
...
$string['showparticipantemails_help'] = 'If enabled, participant emails will appear in the grader report, provided that email address is configured to be part of user identity.';
